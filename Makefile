...
assemble: $(OBJECTS)
	...
	@armips asm/main.asm
	@$(PRINT)$(GREEN)n64crc $(ENDGREEN)$(BLUE)"rom/mp1-mp3.mod.z64"$(ENDBLUE)$(ENDCOLOR)$(ENDLINE)
	@./n64crc.exe "rom/mp1-mp3.mod.z64"
...
genMain:
	...
	$(file >> $(OUTPUT_FILE),.open "rom/mp1-mp3.z64", "rom/mp1-mp3.mod.z64", 0 // Open the ROM file)
...
# we use the extra ROM space of mp1 to store all of our custom code
	$(file >> $(OUTPUT_FILE),.headersize 0x7E712B00)
